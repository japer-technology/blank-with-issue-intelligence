...
A repo based AI assistant that runs entirely through GitHub Issues and Actions. Drop a single `.issue-intelligence` folder into any repo and you have a fully functional AI agent — no servers, no external services, no extra infrastructure.
